...
# Fixed by: jax-ml/jax#35218 (merged 2026-03-17, main).
# Ships in JAX 0.9.3 (stable). Nightly containers report "0.9.2devYYYYMMDD"
# which packaging.version treats as a pre-release of 0.9.2; any post-2026-03-17
# nightly build contains the fix, so we accept "0.9.2.dev0" as the floor.
