...
#ifndef TRANSFORMER_ENGINE_MXFP8_KF_BIDIM_KERNEL_H_
#define TRANSFORMER_ENGINE_MXFP8_KF_BIDIM_KERNEL_H_
 ...
 * cast_kf_bidim.cu for the layout and tuning rationale.
 *
...
#endif  // TRANSFORMER_ENGINE_MXFP8_KF_BIDIM_KERNEL_H_
